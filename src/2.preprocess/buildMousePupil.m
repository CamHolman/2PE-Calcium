function mouseP = buildMousePupil(aqDir, datDir, spRes, tRes, eType, outDir)
    %{
...
%}
    ...
    %% Extract AQuA data
        ...
        mouseP = buildMouse(aqDir, datDir, spRes, tRes,eType, outDir)

    %% Extract Pupil Data
        pupils = readPupil(datDir)

    %% Add Pupil Data
        mouseP.pupils = pupils
